...
![1556105351787](C:\Users\user\AppData\Local\Temp\1556105351787.png)
...
![1556109463023](C:\Users\user\AppData\Local\Temp\1556109463023.png)

我们希望可以在B和C之间加一个F,Diff算法默认 执行起来是这样的：

![1556109479220](C:\Users\user\AppData\Local\Temp\1556109479220.png)
...
![1556109518410](C:\Users\user\AppData\Local\Temp\1556109518410.png)

所以一句话，***key的作用主要是为了高效的更新虚拟DOM***。另外vue的在使用相同标签名元素的过渡切换时，也会使用到key属性，其目的也是为了让vue可以区分他们，否则vue只会替换其内部属性而不会触发过渡效果。

```html 
'<my-com v-for="(item,index) in arr" :obj="item" :dd="index" :key="item.id"></my-com>' 
```
